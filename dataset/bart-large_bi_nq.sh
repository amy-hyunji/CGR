CUDA_VISIBLE_DEVICES=1 python dump_bi_full_corpus.py --corpus kilt_total_corpus.csv --train_file total_nq/nq_train.csv --dev_file total_nq/nq_dev.csv --test_file total_nq/nq_dev.csv --save_path total_nq/t5_large.nq_full --emb_path facebook/bart-large --bart --dump_batch 50
