CUDA_VISIBLE_DEVICES=0 python dump_bi_full_corpus.py --corpus n_kilt_total_corpus.csv --train_file total_nq/nq_train.csv --dev_file total_nq/nq_dev.csv --test_file total_nq/nq_dev.csv --save_path total_nq/t5_large.nq_full --emb_path t5-large --t5 --dump_batch 100 --action dump
