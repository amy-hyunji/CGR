...
from torch.nn import CrossEntropyLoss, MarginRankingLoss, KLDivLoss
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config: T5Config):
        ...
        '''
        self.use_candidate = config.use_candidate
        if self.use_candidate == True:
            self.tokId2candidate = self.set_candidate(config.tokId2candidate)
        self.use_dontcare = config.use_dontcare
        self.use_rank_loss = config.use_rank_loss
        self.use_kl_loss = config.use_kl_loss
        if self.use_kl_loss:
    ...
    def set_candidate(self, file):
        tokId2candidate = pickle.load(open(file, "rb"))
        return tokId2candidate

    def get_candidate(self, tokId):
        return self.tokId2candidate[tokId]
    ...
    def forward(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        groupId2tokId: Optional[dict] = None,
